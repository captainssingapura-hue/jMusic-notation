 ...
 * {@code Phrase} in the final cutover step, replacing the old sealed
 * {@code Phrase} family ({@code MelodicPhrase}, {@code DrumPhrase}, …).
 ...
 *   <li>{@link JoinedPhrase} — composes multiple child {@code BarPhrase}s
 *       with a {@link ConnectingMode} controlling their stitch.</li>
 * </ul>
 *
 * <p>The canonical contract is {@link #bars()} — every BarPhrase
 ...
 */
public sealed interface BarPhrase permits LeafPhrase, JoinedPhrase {
