...
final class DefaultTwinkleStar implements PieceContentProvider<TwinkleStar> {
    ...
    public Piece create() {
        ...
        var melody = new Track("Melody", FLUTE, List.of(
        ...
        var accompaniment = new Track("Chords", ACOUSTIC_GUITAR_NYLON, List.of(
