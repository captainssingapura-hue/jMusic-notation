...
final class DefaultBlueLotus implements PieceContentProvider<BlueLotus> {
    ...
    public Piece create() {
        ...
        var lead = new Track("Lead", OVERDRIVEN_GUITAR, List.of(
        ...
        var guitar = new Track("Guitar", ELECTRIC_GUITAR_CLEAN, List.of(
        ...
        var bass = new Track("Bass", ELECTRIC_BASS_FINGER, List.of(
                rest4,
                bassMf, bassCycle,
                bassF, bassCycle,
                bassCycle, bassCycle,
