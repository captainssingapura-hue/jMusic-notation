...
public final class DefaultAntsGoMarching implements PieceContentProvider<AntsGoMarching> {
    ...
    public Piece create() {
        ...
        var lead = Track.of("Lead", FLUTE, List.of(verse1, verse2, ending));
        ...
        var chords = Track.of("Chords", ACOUSTIC_GUITAR_NYLON, List.of(
        ...
        var bass = Track.of("Bass", ACOUSTIC_BASS, List.of(
                new MelodicPhrase(
                        List.of(new DynamicNode(Dynamic.MF),
