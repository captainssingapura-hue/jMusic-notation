...
public final class ManualBachInvention13 implements PieceContentProvider<BachInvention13> {
    ...
    MelodicPhrase buildRhSection1() {
        return newBuilder()
                ...
                .bar(SIXTEENTH).o5(E).o5(C).o4(A).o5(C).o4(EIGHTH,F).o5(EIGHTH,D).o5(D).o4(B).o4(G).o4(B).o4(EIGHTH,E).o5(EIGHTH,C).done()
                .bar(SIXTEENTH).o5(C).o4(A).o4(F).o4(A).o4(EIGHTH,D).o4(EIGHTH,B).o5(EIGHTH,C).r(EIGHTH).r(QUARTER).done()
                .build(attacca());
    }
    ...
    MelodicPhrase buildRhSection2() {
        return newBuilder()
                ...
                .bar().o5(A).o5(F.s()).o5(D.s()).o5(F.s()).o4(B).o5(D.s()).o4(F.s()).o4(A).o4(EIGHTH,G).o5(EIGHTH,G).o5(G).o5(E).o5(C).o5(E).done()
                .bar().o4(EIGHTH,A).o5(EIGHTH,F.s()).o5(F.s()).o5(D).o4(B).o5(D).o4(EIGHTH,G).o5(EIGHTH,E).o5(E).o5(C).o4(A).o5(C).done()
    ...
    MelodicPhrase buildLhSection1() {
        return newBuilder()
                ...
                .bar(SIXTEENTH).o2(EIGHTH,B).o3(EIGHTH,D).o3(EIGHTH,G).o3(EIGHTH,B).o3(B).o3(G).o3(E).o3(G).o3(C).o3(E).o2(G).o2(B).done()
    ...
    MelodicPhrase buildLhSection2() {
        return newBuilder()
                ...
                .bar().o4(F.s()).o4(D).o3(B).o4(D).o3(G).o3(B).o4(D).o4(F.s()).o4(E).o4(C).o3(A).o4(C).o3(F.s()).o3(A).o4(EIGHTH,C).done()
                .bar().o4(C).o3(B).o4(C).o3(A).o3(EIGHTH,B).o2(EIGHTH,B).o3(E).o4(E).o3(B).o3(G).o3(E).o2(B).o2(G).o2(B).done()
                .build(attacca());
    }
