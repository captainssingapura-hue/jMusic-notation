...
public final class DefaultBachInvention13 implements PieceContentProvider<BachInvention13> {
    ...
    public Piece create() {
        ...
        final var rightHand = Track.of("Right Hand", ACOUSTIC_GRAND_PIANO, List.of(
                mp(Dynamic.MF, rh1, attacca()),
                new MelodicPhrase(rh2, attacca()),
                mp(Dynamic.MP, rh3, attacca()),
                mp(Dynamic.MF, rh4, end())));

        final var leftHand = Track.of("Left Hand", ACOUSTIC_GRAND_PIANO, List.of(
